...
class MCSSOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--scene_id", type=str, help="the name of the scene", default="val")

        self.parser.add_argument("--min_scene_ind", type=int, help="the name of the scene", default=0)
        self.parser.add_argument("--max_scene_ind", type=int, help="the name of the scene", default=251)
