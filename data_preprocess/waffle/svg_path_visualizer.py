...
def visualize_commands():
    ...
    commands = {
        ...
        "H_absolute": {"description": "Horizontal line to absolute X", "path_data": "M 100 100 H 200 V 200 H 100 Z"},
        "h_relative": {"description": "Horizontal line relative X", "path_data": "M 100 100 h 100 v 100 h -100 Z"},
        "V_absolute": {"description": "Vertical line to absolute Y", "path_data": "M 100 100 H 200 V 200 H 100 Z"},
        "v_relative": {"description": "Vertical line relative Y", "path_data": "M 100 100 h 100 v 100 h -100 Z"},
        "C_cubic": {
        ...
        "A_arc": {"description": "Elliptical arc absolute", "path_data": "M 100 200 A 100 50 0 1 0 300 200"},
        "a_arc_relative": {"description": "Elliptical arc relative", "path_data": "M 100 200 a 100 50 0 1 0 200 0"},
        "Z_closepath": {"description": "Close path command", "path_data": "M 100 100 L 200 100 L 150 200 Z"},
    }
...
def main():
    ...
    parser.add_argument(
        "--output-dir", default="visualizations", help="Directory to save visualizations (default: visualizations)"
    )
