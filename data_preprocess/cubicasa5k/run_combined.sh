...
python combine_json.py \
    --input /share/elor/htp26/floorplan_datasets/coco_cubicasa5k_nowalls_v5-2_refined/ \
    --output /share/elor/htp26/floorplan_datasets/coco_cubicasa5k_nowalls_v5-2_refined/annotations/ \