...
from clipseg_eval.general_utils import load_model, log, score_config_from_cli_args, AttributeDict, get_attribute, filter_args
...
def score(config, train_checkpoint_id, train_config):
    ...
    if config.test_dataset == 'pascal':
        ...
        for split in splits:
            ...
            metric = FixedIntervalMetrics(resize_pred=True, sigmoid=True, 
                                          custom_threshold=shift, **metric_args)
