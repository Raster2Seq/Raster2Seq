...
max_samples = 100
path_A = "waffle_benchmark_preds/cubi_v4-1refined_queries56x50_sem_v1/"
path_B = "waffle_benchmark_preds/cubi_v4-1refined_poly2seq_l512_bin32_sem_coo20_cls5_nopolyrefine_predecPE_fromckpt_ignorewd_smoothing_t1/"
path_gt = "/home/htp26/RoomFormerTest/data/waffle/benchmark/segmented_pngs"
...
gt = sorted(glob(f'{path_gt}/*.png'))[:max_samples]
...
cols = [
    ...
    Col('img', 'GT', gt),                                           # specify image content for column 2
...
imagetable(cols, out_file='waffle_vis.html', imsize=(768, 768))