...
class DeformableTransformer(nn.Module):
    def __init__(self, d_model=256, nhead=8,
                 ...
                 dec_attn_concat_src=False, dec_qkv_proj=True):
        super().__init__()
    ...
    # def forward_inference(self, srcs, masks, pos_embeds, query_embed=None, tgt=None, tgt_masks=None,
    ...
    #     if tgt_masks is None:
    #         # make causal mask
    #         tgt_masks = self._create_causal_attention_mask(tgt.shape[1]).to(memory.device)

    #     # decoder
    #     hs, inter_references, inter_classes = self.decoder.forward_inference(tgt, reference_points, memory, src_flatten,
    #                                         spatial_shapes, level_start_index, valid_ratios, query_pos, mask_flatten, tgt_masks,
    #                                         pre_decoder_pos_embed=self.pre_decoder_pos_embed,)
