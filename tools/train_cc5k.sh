...
#SBATCH --gres=gpu:6000ada:1                # Type/number of GPUs needed
...
JOB=cubi_v4-1refined_poly2seq_l${SEQ_LEN}_bin${NUM_BINS}_sem${SEM_COEFF}_coo${COO_COEFF}_cls${CLS_COEFF}_anchor_deccatsrc_smoothing_cls12_convert${CONVERTER}_fromnorder499_t1
